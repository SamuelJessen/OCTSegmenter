#!/bin/bash
#SBATCH --job-name=lumi_training_gentuity_deeplabv3plus_cv
...
# Run the job
srun /usr/bin/singularity exec -B /projappl/project_465001544/OCTSegmenter:/mnt -B /flash/project_465001544/:/data cotainrImage.sif python /mnt/lumi_training/lumi_training_gentuity_deeplabv3plus_cv.py
